...
🌿Ever-growing design library for new Gutenberg blocks editor.
...
* Gutenberg Rows – Advanced section settings for Gutenberg
...
* Gutenberg Sections – Full-width layouts in Gutenberg
...
* WooCommerce Blocks – Gutenberg WooCommerce Integration
...
🎁 Checkout free [block styling plugin for Gutenberg](https://wordpress.org/plugins/stylist/).
...
* 🐞 Fixed [broken panel tabs](https://wordpress.org/support/topic/menu-text-overlap-in-carrot-menu/) in Gutenberg 5.2
...
* 🐞 Fixed error ["No route was found"](https://wordpress.org/support/topic/no-route-was-found/)
