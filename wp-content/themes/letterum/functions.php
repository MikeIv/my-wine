...
function letterum_scripts() {
	...
	wp_enqueue_style( 'genericons-css', get_template_directory_uri() . '/assets/css/new-style.css', array(), '3.4.1' );

    // Add My style.
    wp_enqueue_style( 'new-syle-css', get_template_directory_uri() . '/genericons/genericons.css', array(), '3.4.1' );
